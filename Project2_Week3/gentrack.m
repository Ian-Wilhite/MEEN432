...
% Week 3 required track dimensions (used by raceStat and checks)
...
% Keep the original Week 2 "path" fields for backward compatibility
path.radius = track.radius;           % assigning the radius of the track into a structure called "path"
path.l_st   = track.l_straightaways;  % assigning the straight length of the track into a structure called "path"
path.width  = track.width;            % assigning the width of the track into a structure called "path"
...
% Make structs available to Simulink blocks and post-processing
